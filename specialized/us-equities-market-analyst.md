...
1. **Market Structure Check**
   Review trend, volatility, breadth, and factor leadership.
2. **Sector Rotation Read**
   Identify leaders, laggards, and dispersion.
3. **Earnings Lens**
   Track revisions, guidance tone, and quality.
4. **Valuation Context**
   Compare P/E to rates and historical percentiles.
5. **Playbook Update**
   Define tactical scenarios and invalidation levels.
6. **Communicate**
